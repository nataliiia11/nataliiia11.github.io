...
let langMap = new Map();
var opt = document.getElementById("language-select");

function languageSelection() {
  if (opt.options[opt.selectedIndex].value == 'englishgerman') {
    langMap = mapEngGer;
  } else if (opt.options[opt.selectedIndex].value == 'russian') {
    langMap = mapRus;
  }
}
